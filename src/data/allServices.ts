...
export const ALL_SERVICES: ServicePageContent[] = [
  ...
  },
  {
    ...
    pageTitle: 'mTBI (Mild Traumatic Brain Injury) & Concussion Evaluation — Texas NeuroTrauma Institute',
    domain: 'Assessment',
    heroTitle: 'mTBI (Mild Traumatic Brain Injury)',
    heroTitleAccent: '& Concussion Evaluation',
    tagline: 'Evaluation and recovery for mild traumatic brain injury (mTBI) and concussion.',
    heroIntro:
      'A concussion is a mild traumatic brain injury (mTBI). It can affect memory, concentration, balance, vision, mood, and overall brain function. This service provides structured evaluation and management for children, adolescents, and adults after sports impacts, motor vehicle collisions, workplace injuries, falls, or other head trauma.',
    expertTitle: 'Who mTBI (Mild Traumatic Brain Injury) & Concussion Care Is For',
    expertBody:
      'This service may be appropriate after a head impact when symptoms are new, persistent, worsening, or interfering with school, work, sports, or daily activity.',
    expertItems: [
      'Suspected or confirmed mild traumatic brain injury (mTBI)',
      'Recent concussion or head impact with ongoing symptoms',
      'Persistent headaches, dizziness, or cognitive changes',
      'Difficulty returning to work, school, or sports',
    ],
    offeringsEyebrow: 'mTBI & Concussion Care',
    offeringsTitle: 'What mTBI (Mild Traumatic Brain Injury) & Concussion Care Includes',
    offeringsIntro:
      'Structured evaluation and recovery planning for mild traumatic brain injury and concussion across every stage of healing.',
    offerings: [
      { title: 'Comprehensive mTBI & Concussion Evaluations', body: 'Thorough neurological and cognitive assessments to diagnose injury severity and identify symptoms affecting brain function.' },
    ...
    whyChooseIntro:
      'Recovering from mTBI or concussion requires specialized expertise and a coordinated approach to care. Our team is dedicated to helping patients recover safely while minimizing the risk of persistent symptoms.',
    whyChoose: [
      { title: 'Specialized mTBI & Concussion Experts', body: 'Clinicians experienced in diagnosing and treating sports-related, occupational, and accident-related mild traumatic brain injuries.' },
      { title: 'Evidence-Based Care', body: 'Advanced assessment tools and treatment protocols based on the latest concussion and mTBI research and clinical guidelines.' },
    ...
    approachTitle: 'How mTBI (Mild Traumatic Brain Injury) & Concussion Care Progresses',
    approachBody:
    ...
    heroImageLabel: 'mTBI (Mild Traumatic Brain Injury) & Concussion Evaluation',
  ...
  },
  {
    ...
    pageTitle: 'TBI (Traumatic Brain Injury) Evaluation — Texas NeuroTrauma Institute',
    domain: 'Assessment',
    heroTitle: 'TBI (Traumatic Brain Injury)',
    heroTitleAccent: 'Evaluation',
    tagline: 'Physician-led evaluation for traumatic brain injury (TBI) and complex post-injury neurological symptoms.',
    heroIntro:
      'This evaluation is the starting point for patients with suspected or confirmed traumatic brain injury. It brings the injury history, neurological examination, symptom pattern, mechanism of injury, and available imaging into one clinical picture — then defines a clear plan for testing, treatment, and recovery.',
    expertTitle: 'Who TBI (Traumatic Brain Injury) Evaluation Is For',
    expertBody:
      'A TBI evaluation may be appropriate when neurological or cognitive symptoms persist after a traumatic brain injury and require a coordinated physician-directed assessment.',
    expertItems: [
      'Suspected or confirmed traumatic brain injury (TBI)',
      'Motor vehicle collisions and workplace injuries',
      'Falls and other traumatic events',
      'Sports-related impacts with ongoing neurological symptoms',
    ],
    offeringsEyebrow: 'TBI Evaluation',
    offeringsTitle: 'What TBI (Traumatic Brain Injury) Evaluation Includes',
    offeringsIntro:
      'A structured, physician-directed workup that establishes diagnosis, severity, and next steps for traumatic brain injury care.',
    offerings: [
    ...
    whyChooseIntro:
      'Physician-directed TBI evaluation ensures that advanced testing and rehabilitation are guided by clinical judgment — not isolated test results.',
    whyChoose: [
      { title: 'Physician-Led Care', body: 'Evaluations directed by clinicians experienced in traumatic brain injury, concussion, and complex post-injury presentations.' },
    ...
    heroImageLabel: 'TBI (Traumatic Brain Injury) Evaluation',
    heroImageSrc: concussionManagementHero,
